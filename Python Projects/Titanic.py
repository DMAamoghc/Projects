...
print("Rohan's odds of survival: ", model.predict([[2, 0, 10, 2, 0, 80.00]])[0][1])
...
print("William's odds of survival: ", model.predict([[3, 0, 16, 3, 0, 80.00]])[0][1])
print("Luke's odds of survival: ", model.predict([[1, 0, 14, 3, 0, 80.00]])[0][1])
print("Adam's odds of survival: ", model.predict([[1, 0, 21, 2, 0, 80.00]])[0][1])